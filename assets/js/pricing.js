...
$('#pricing-toggle').on('click', function () {
  ...
  if ($('#standard').parent().closest('div').attr('class') == 'pricing__card card pricing__card--year') {
    $('#standard').attr("href", "https://buy.stripe.com/5kA6pFe886xP35K4gh")
    $('#pro').attr("href", "https://buy.stripe.com/fZecO35BCaO5bCg4gj")
  } else {
    $('#standard').attr("href", "https://buy.stripe.com/dR6g0fd44aO59u88ww")
    $('#pro').attr("href", "https://buy.stripe.com/9AQ8xN5BC6xPgWAbIK")
  }
});
